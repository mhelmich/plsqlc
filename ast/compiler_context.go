...
// func runtimeScope() *scope {
// 	s := newScope()
// 	s.Members[runtime.EqualStringFuncName] = runtime.EqualStringFunc
// 	s.Members[runtime.PrintIntFuncName] = runtime.PrintIntFunc
// 	s.Members[runtime.PrintStringFuncName] = runtime.PrintStringFunc
// 	return s
// }
